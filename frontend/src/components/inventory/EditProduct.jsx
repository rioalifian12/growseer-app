...
import { fetchProductById, updateProduct } from "../../services/ServiceProduct";
import Swal from "sweetalert2";

const EditProduct = ({ id, onProductUpdated }) => {
  ...
  useEffect(() => {
    const getProductById = async () => {
      ...
      if (product) {
        ...
        setValue("pricePerCarton", product.pricePerCarton);
        setValue("pricePerBox", product.pricePerBox);
        setValue("boxPerCarton", product.boxPerCarton);
        setValue("stockCarton", product.stockCarton);
